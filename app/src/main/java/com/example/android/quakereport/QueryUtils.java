...
/**
 * Created by priyankanandiraju on 12/26/16.
 */

public final class QueryUtils {
    /** Sample JSON response for a USGS query */
    public static final String EQ_URL = "http://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=6&limit=10";
        ...
        public static List<EarthQuake> extractEarthquakes(String jsonResponse) {
            ...
            try {
                ...
                for (int i = 0; i < featuresArray.length(); i++) {
                    ...
                    earthQuake.add(new EarthQuake(mag, place, time, url));
                }
